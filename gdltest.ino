...
#define TFT_DC  8//D2
#define TFT_CS  1//D6
#define TFT_RST 14//D3
#define TFT_BL  9//D9



#define COLOR2_RGB565_BLACK         0xFFFF
#define COLOR2_RGB565_BLUE          0x001F
#define COLOR2_RGB565_RED           0xF800
#define COLOR2_RGB565_GREEN         0x07E0
#define COLOR2_RGB565_CYAN          0x07FF
#define COLOR2_RGB565_MAGENTA       0xF81F
#define COLOR2_RGB565_YELLOW        0xFFE0
#define COLOR2_RGB565_WHITE         0x0000
#define COLOR2_RGB565_NAVY          0x000F
#define COLOR2_RGB565_DARKGREEN     0x03E0
#define COLOR2_RGB565_DARKCYAN      0x03EF
#define COLOR2_RGB565_MAROON        0x7800
#define COLOR2_RGB565_PURPLE        0x780F
#define COLOR2_RGB565_OLIVE         0x7BE0
#define COLOR2_RGB565_LIGHTGREY     0xC618
#define COLOR2_RGB565_DARKGREY      0x7BEF
#define COLOR2_RGB565_ORANGE        0xFD20
#define COLOR2_RGB565_GREENYELLOW   0xAFE5
#define COLOR2_RGB565_DCYAN        0x03EF
 ...
 * COLOR2_RGB565_BLACK   COLOR_RGB565_NAVY    COLOR_RGB565_DGREEN   COLOR_RGB565_DCYAN 
...
void setup() {
  Serial.begin(115200);
  screen.begin();
  screen.fillScreen( COLOR2_RGB565_LIGHTGREY);//COLOR2_RGB565_LGRAY);
/*
...
void loop(void){
  ...
  uint32_t usecLines = testLines( COLOR2_RGB565_BLUE);
  uint32_t usecFastLines = testFastLines( COLOR2_RGB565_RED,  COLOR2_RGB565_BLUE);
  uint32_t usecRects = testRects( COLOR2_RGB565_GREEN);
  uint32_t usecFilledRects = testFilledRects( COLOR2_RGB565_YELLOW,  COLOR2_RGB565_MAGENTA);
  uint32_t usecFilledCircles = testFilledCircles(10,  COLOR2_RGB565_MAGENTA);
  uint32_t usecCircles = testCircles(10,  COLOR2_RGB565_WHITE);
  ...
  */
  ...
  screen.setTextColor( COLOR2_RGB565_MAGENTA);
  screen.setTextSize(2);
  screen.setCursor(30, 60);
  screen.println(F("GDL test"));

  screen.setTextSize(1);
  screen.setTextColor( COLOR2_RGB565_WHITE);
  screen.println(F(""));
  screen.setTextSize(1);
  screen.println(F(""));
  ...
  screen.setTextColor( COLOR2_RGB565_GREEN);
  screen.println(F(""));
 

  screen.setTextColor( COLOR2_RGB565_CYAN); screen.setTextSize(1);
  screen.print(F("Screen fill          "));
  screen.setTextColor( COLOR2_RGB565_YELLOW);
...
uint32_t testFillScreen()
{
  uint32_t start = micros_start();
    ...
    screen.fillScreen( COLOR2_RGB565_WHITE);
    screen.fillScreen( COLOR2_RGB565_RED);
    screen.fillScreen( COLOR2_RGB565_GREEN);
    screen.fillScreen( COLOR2_RGB565_BLUE);
    screen.fillScreen( COLOR2_RGB565_BLACK);//COLOR2_RGB565_BLACK);
...
uint32_t testText()
{
  screen.fillScreen( COLOR2_RGB565_BLACK);//BLUE);
  uint32_t start = micros_start();
  screen.setCursor(0, 0);
  screen.setTextColor( COLOR2_RGB565_WHITE, COLOR2_RGB565_BLACK);  screen.setTextSize(1);
  ...
  screen.setTextColor( COLOR2_RGB565_YELLOW); screen.setTextSize(2);
  screen.println(1234.56);
  screen.setTextColor( COLOR2_RGB565_RED);    screen.setTextSize(3);
...
uint32_t testLines(uint16_t color)
{
  ...
  screen.fillScreen( COLOR2_RGB565_BLACK);

 ...
 *COLOR2_RGB565_BLACK   COLOR2_RGB565_NAVY    COLOR2_RGB565_DGREEN   COLOR2_RGB565_DCYAN 
 *COLOR2_RGB565_MAROON  COLOR2_RGB565_PURPLE  COLOR2_RGB565_OLIVE    COLOR2_RGB565_LGRAY     
 *COLOR2_RGB565_DGRAY   COLOR2_RGB565_BLUE    COLOR2_RGB565_GREEN    COLOR2_RGB565_CYAN  
 *COLOR2_RGB565_RED     COLOR2_RGB565_MAGENTA COLOR2_RGB565_YELLOW   COLOR2_RGB565_ORANGE           
 *COLOR2_RGB565_WHITE   
 */
...
void loop(){
    testDrawPixel();
    testLine();
    testFastLines(COLOR2_RGB565_PURPLE,COLOR2_RGB565_YELLOW);       
    testRects(COLOR2_RGB565_BLACK,COLOR2_RGB565_WHITE);
    testRoundRects();
    testCircles(24,COLOR2_RGB565_BLUE);
    testTriangles(COLOR2_RGB565_YELLOW);
    testPrint();
...
void testDrawPixel() {
  ...
  for(int i = 0; i <= screen.width()/2; i += 10){
    for (x = screen.width() - i; x >= i; x-=10 ){
       ...
       * c pixel color
       */
      screen.drawPixel(x, y, COLOR2_RGB565_ORANGE);
      delay(10);
    }
